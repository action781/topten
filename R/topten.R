...
#' @details
#' This function runs a univariate regression of y on each predictor of x and
#' calculates a p-values indicating the significance of the association.  The final set
#' of 10 predictors is taken from the 10 smallest p-values.
#' @seealso \code{lm}
#' @export
#' @importFrom stats lm
#'
...
#' @param b a vector of coefficients ombtained from the \code{topten} function
